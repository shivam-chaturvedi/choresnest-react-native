...
import {
  trackAuthMethodUsage,
  trackGuestModeEngaged,
...
export const AuthScreen: React.FC<AuthScreenProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    if (isLogin) {
      ...
      if (success) {
        void trackAuthMethodUsage('email', 'login');
        showToast({
          type: 'success',
          title: 'Welcome back!',
  ...
  const handleGuestLogin = async () => {
    try {
      ...
      setIsSubmitting(true);
      await loginAsGuest();
      void trackGuestModeEngaged();
      void trackAuthMethodUsage('guest', 'login');
      console.log(
        'AuthScreen: Guest login complete, triggering authentication',
      );
      onAuthenticated();
    } catch (error) {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      void trackAuthMethodUsage('google', 'login');
    } finally {
      setIsSubmitting(false);
    }
  };
    ...
    >
      ...
      >
        ...
        <Text
          style={[
            styles.subtitle,
            { color: theme.colors.primaryForeground + 'D9' },
          ]}
        >
      ...
      <View style={styles.formWrapper}>
        ...
        >
          <View
            style={[
              styles.tabs,
              { backgroundColor: theme.colors.muted, borderRadius: radius.lg },
            ]}
          >
            <Pressable
          ...
          {isLogin && (
            ...
            >
              <Text style={[styles.forgotText, { color: midnightAccentColor }]}>
                Forgot Password?
              </Text>
            </Pressable>
          )}
          ...
          >
            ...
            <Text
              style={[styles.googleButtonText, { color: midnightAccentColor }]}
            >
        ...
        >
          ...
          <View style={styles.infoTextContainer}>
            <Text
              style={[styles.infoTitle, { color: theme.colors.foreground }]}
            >
      ...
      <View style={styles.footer}>
        <Text
          style={[styles.footerText, { color: theme.colors.mutedForeground }]}
        >
