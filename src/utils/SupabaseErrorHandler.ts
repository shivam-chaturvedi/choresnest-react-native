...
const ERROR_MESSAGES: Record<string, string> = {
    ...
    'email_provider_disabled': 'Email authentication is currently unavailable. Please try again later.',
...
export function getHumanReadableMessage(error: any, context?: string): string {
    ...
    if (error.message?.includes('fetch') || error.message?.includes('network') || error.name === 'FetchError') {
