...
export const SYNC_TABLES: TableSyncConfig[] = [
  ...
  {
    key: 'collection_recipes',
    remoteTable: 'collection_recipes',
    phase: 3,
    hasProfileId: true,
    addProfileId: true,
  },
  { key: 'folders', phase: 1, hasProfileId: true, addProfileId: true },
  ...
  { key: 'transactions', phase: 2, hasProfileId: true, addProfileId: true },
  { key: 'budgets', phase: 2, hasProfileId: true, addProfileId: true },
  {
    key: 'budget_category_color_mappings',
    phase: 2,
    hasProfileId: true,
    addProfileId: true,
  ...
  { key: 'meal_plans', hasProfileId: true, addProfileId: true, phase: 2 },
  {
    key: 'list_items',
    remoteTable: 'list_items',
    hasProfileId: true,
    addProfileId: true,
    phase: 2,
  },
